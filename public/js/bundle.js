...
/*  eslint-disable  */
var hideAlert = function hideAlert(type, message) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              // location.reload(true); //reload coming down from server
              location.reload(); // reload page from browser cache
            }
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGRhdGR0MTIiLCJhIjoiY2tyN200MHRtM3FpeDJubGZwdXhhZWE0eCJ9.-D03062BJrCrDkoCRzWB8w';
  ...
  for (var _len = arguments.length, fitPadding = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    fitPadding[_key - 1] = arguments[_key];
  }

  console.log(fitPadding); // fitPadding[0] : top
  // fitPadding[1] : left
  // fitPadding[2] : bottom
  // fitPadding[3] : right
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"resetPasswordFunc.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resetPassword = exports.sendResetEmail = void 0;
...
var sendResetEmail = /*#__PURE__*/function () {
  ...
  return function sendResetEmail(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var resetPassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(newPassword, passwordConfirm, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "You've successfully changed your password");
              window.setTimeout(function () {
...
var _resetPasswordFunc = require("./resetPasswordFunc");
...
if (passwordForm) {
  passwordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)('password', {
...
if (registerForm) {
  ...
  registerForm.addEventListener('submit', function (e) {
    ...
    (0, _login.register)(name, email, password, passwordConfirm);
  });
}
...
var thanksLetter = document.getElementById('thanks-letter');

if (resetForm) {
  resetForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    var status = (0, _resetPasswordFunc.sendResetEmail)(email);
